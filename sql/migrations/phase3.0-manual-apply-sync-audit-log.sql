CREATE TABLE IF NOT EXISTS sync_runs (
    ...
    PRIMARY KEY (id),
    KEY idx_sync_runs_clan (clan_id),
    KEY idx_sync_runs_guild (discord_guild_id)
...
CREATE TABLE IF NOT EXISTS sync_run_members (
    ...
    updated_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    PRIMARY KEY (id),
    KEY idx_sync_run_members_run (sync_run_id),
    KEY idx_sync_run_members_user (discord_user_id),
    CONSTRAINT fk_sync_run_members_run FOREIGN KEY (sync_run_id) REFERENCES sync_runs(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
